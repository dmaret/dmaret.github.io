...
(function(){
  ...
  function cleanDuplicateFooters(){
    ...
    for(var i=0;i<all.length;i++){
      ...
      var hasMaret=txt.indexOf('MARET')!==-1||txt.indexOf('D.MARET')!==-1;
  ...
  if(!isPortal){
    ...
    d.innerHTML='<strong style="color:#6b6356;">© 2025–2026 D.MARET™ — Tous droits réservés</strong><br><br>'+
      ...
      '<strong style="color:#6b6356;">Attribution :</strong> Si vous utilisez ou vous inspirez de ces projets, veuillez citer la source : D.MARET™ © 2025–2026';
